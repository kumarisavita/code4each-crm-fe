...
<template>
  <Modal
    ...
    modal-id="agencyModal"
    :show-footer="false"
  >
    <template #header>
      <h4 class="modal-title text-center" id="agencyModalLabel">
        Agency Details
      </h4>
      <button
        type="button"
    ...
    <form
      @submit.prevent="submitAgencyDetail"
      enctype="multipart/form-data"
      slot="body"
    >
      <div v-if="errorMessage" class="error-message text-danger text-center">
        {{ errorMessage }}
      </div>
      ...
      <div class="form-group">
        ...
        <VeeInput
          ...
          :hiddenValue="dashboardData?.user?.agency?.name"
          label="Business Name"
        />
        <VeeInput
          name="address"
        ...
        <VeeInput
          name="agency_id"
          type="hidden"
          :hiddenValue="dashboardData.user.agency_id"
        />
